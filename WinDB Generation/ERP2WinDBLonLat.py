    ...
    while(cap.isOpened()):
        ...
        if ret==True:
            ...
            for mydeg in range(0, 1):
                ...
                for nn in range(0, 3):  ## 第一行,辅屏
                    mu_deg = -120+nn*120
                    equ = E2P.Equirectangular(img)    # Load equirectangular image
                    Perimg, lonlat = equ.GetPerspective(80, 50, mu_deg, 67, int(height*3/2), width*4, mydeg)
                ...
                resultlonlat = np.concatenate((resultBlonlat, resultAlonlat, resultClonlat),axis=0) # 240,1920,2; 960,1920,2; 240,1920,2->1440,1920
