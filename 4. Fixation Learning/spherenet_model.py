...
class SphereNet(nn.Module):
	...
	def forward(self, x):
		...
		out = self.center(out) # 4,256,8,16

		out = self.up4(down4, out) # [4, 128, 16, 32]
		out = self.up3(down3, out) # [4, 64, 32, 64]
		out = self.up2(down2, out) #[4, 24, 64, 128]
		out = self.up1(down1, out) # [4, 24, 128, 256]
